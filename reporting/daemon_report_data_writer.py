...
if __name__ == '__main__':
    ...
    if sys.argv[1].isdigit():
        ...
        if sys.argv[1] == '2':
            writer = csv.writer(open('/home/ubuntu/reporting_app/current_data_va.csv','wb'), delimiter=',')
            writer1 = csv.writer(open('/home/ubuntu/reporting_app/hourly_data_va.csv','wb'), delimiter=',')
	    for row in hour_by_hour['data']:
		writer1.writerow(row)
	    writer2 = csv.writer(open('/home/ubuntu/reporting_app/daily_data_va.csv','wb'), delimiter=',')
