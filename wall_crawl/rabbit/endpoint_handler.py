...
####################################################################
        # celery integration point
        # crawl_user calls a specific crawl_realtime_updates task
        # WILL INVOKE CELERY TASK ?
        # from tasks import crawl_user
        # fbid, update_time im cur_data['data']:
            # crawl_user.delay(fbid, update_time)
            # 


# call this url to check the current subscriptions we have
# http://50.16.226.172:5000/check_subscriptions
# will return a json blob for you
...
# just change the above subscribe_app() to accommodate
# the additional subscriptions you want and call this url
# http://50.16.226.172:5000/subscribe
